...
<form action="editar_noticia.php" method="POST">
  <div class="row">
    <div class="col">
      ...
      <input type="text" name="imagen_mentor" class="form-control" value="<?php echo $noticiaRow['imagen_mentor'] ?>">
      ...
      <input type="text" name="imagen" class="form-control" value="<?php echo $noticiaRow['imagen'] ?>">
