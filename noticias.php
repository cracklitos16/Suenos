                  ...
                  <div class="col-xxl-8 col-xl-8 col-lg-8">
                     <div class="course__wrapper">
                        <div class="page__title-content mb-25">                          
                           ...
                           <span class="breadcrumb__title-pre">Marketing</span>
                           <h5 class="breadcrumb__title-2">Marketing Digital 2022</h5>
                        </div>
                           ...
                           <div class="tab-content" id="courseTabContent">
                              <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                 <div class="course__description">
                                    ...
                                    <div class="course__description-list mb-45">
                                       <h4>¿Para quien es el curso?</h4>
                                       <ul>
                                          <li> <i class="fa-solid fa-check"></i> Gerentes de empresas, líderes</li>
                                          <li> <i class="fa-solid fa-check"></i> Conferencias descargables, código y recursos de diseño para todos los proyectos</li>
                                           ...
                                           <div class="accordion-body">
                                             <div class="course__curriculum-content d-sm-flex justify-content-between align-items-center">
                                                <div class="course__curriculum-info">
                                                   ...
                                                   <h3> <span>Documento:</span> Archivos para trabajar el curso</h3>
                                                </div>
                              ...
                              <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                                 <div class="course__review">
                                    <h3>Reseñas</h3>
                                    <p>Reseñas de los miembros que han tomado el curso</p>
                                          ...
                                          <li>
                                             <div class="course__comment-box ">
                                                ...
                                                <div class="course__comment-content">
                                                   ...
                                                   <div class="course__comment-text ml-70">
                                                      <p>Tomar un curso con Juan es garantía de diversión y aprendizaje. Tiene el gran talento de explicar cosas que parecen complejas de una forma ágil y divertida. Si te quieres adentrar en el mundo del marketing digital, sin duda alguna Mercatitlán es una gran opción.</p>
                                                   </div>
                                                </div>
                                             </div>
                                          </li>
